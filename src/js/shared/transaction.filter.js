(function () {
    ...
    function TransactionFilter(constants, applicationContext, formattingService) {
        ...
        function processPaymentTransaction(transaction) {
            transaction.formatted.amount = Money.fromCoins(transaction.amount, Currency.EARTHS).formatAmount();
            transaction.formatted.asset = Currency.EARTHS.displayName;
        }
        ...
        function processExchangeTransaction(transaction) {
            ...
            transaction.formatted.fee = Money.fromCoins(totalFee, Currency.EARTHS).formatAmount(true);
